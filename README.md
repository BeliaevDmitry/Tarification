...
- во вкладке учебного плана при добавлении записи корпус подтягивается автоматически из справочника классов
- во вкладке нагрузки ФИО педагога выбирается из справочника (`/api/teachers`) с поиском по набору текста
- верхнее меню фиксированное и единое на всех страницах: **Корпуса → Классы → Учебный план → Нагрузка по корпусам → Педагоги**
