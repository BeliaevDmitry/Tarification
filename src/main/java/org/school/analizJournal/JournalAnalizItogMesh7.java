...
public class JournalAnalizItogMesh7 {

    public static void main(String[] args) {
        String folderPath = "C:\\Users\\dimah\\Yandex.Disk\\ГБОУ 7\\Анализ журнала";
        String excludedStudentsFile = "C:\\Users\\dimah\\Yandex.Disk\\ГБОУ 7\\Анализ журнала\\Учащиеся. Только отчисленные. (5).xlsx";
        String outputPath = "C:\\Users\\dimah\\Yandex.Disk\\ГБОУ 7\\Анализ журнала\\результат_анализа_МЭШ.xlsx";
