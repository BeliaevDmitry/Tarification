...
public final class HrDocumentDtos {
    ...
    public record MemoView(Long id, String academicYear, Long teacherId, Long contractId, Long catalogItemId,
            ...
            String assignmentText, String agreementText, String contractClause, String dutiesText,
            LocalDateTime createdAt, String createdBy, LocalDateTime issuedAt, LocalDateTime signedAt,
            String archiveReason, boolean deletable) {}
