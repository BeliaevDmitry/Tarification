...
public enum AppTab {
    ...
    TEACHERS_SETTINGS("Нагрузка: правила расчёта ЗП", "/teachers.html#settings"),
    TEACHERS_MCKO("Качество: МЦКО педагогов", "/teachers.html#mcko"),
    TEACHERS_TIME_OFF("Сотрудники: отгулы", "/teachers.html#time-off"),
    CONTINGENT_IMPORT("Обучающиеся: импорт", "/contingent.html#import"),
    CONTINGENT_STATS("Обучающиеся: численность", "/contingent.html#stats"),
    CONTINGENT_ADMISSION("Обучающиеся: приём", "/contingent.html#admissions"),
    CONTINGENT_CLASS_TRANSFERS("Обучающиеся: переводы между классами", "/contingent.html#transfers"),
    CONTINGENT_ADMISSION_ROLES("Обучающиеся: роли приёма", "/contingent.html#roles"),
    OVZ("Обучающиеся: ОВЗ и сопровождение", "/ovz.html"),
    SUBJECT_AREAS("Предметные области", "/subject-areas.html"),
    EDUCATIONAL_WORK("Воспитательная работа", "/educational-work.html"),
    CLASS_TEACHER_EXIT_ORDER_CREATE("Документы: подача заявки на выход", "/class-teacher.html#create"),
    CLASS_TEACHER_EXIT_ORDER_SUMMARY("Документы: свои заявки на выход", "/class-teacher.html#summary"),
    ...
    public static List<AppTab> navigableTabs() {
        return Arrays.asList(HR_DOCUMENTS, HR_PERSONAL_DATA, BUILDINGS, CLASSES, SUBJECTS, CURRICULUM, LOAD, PEOPLE_LOAD, LOAD_ISSUES, LOAD_MASTER_FOT, LOAD_STATS,
                ...
                TEACHERS_SETTINGS, TEACHERS_MCKO, TEACHERS_TIME_OFF, SERVICE_NOTES, HR_NOTIFICATIONS_VIEW, CONTINGENT_IMPORT, CONTINGENT_STATS,
