...
public class LoadInRateSchemaInitializer implements ApplicationRunner {
    ...
    private void migrateRules() {
        ...
        jdbcTemplate.execute("""
                ...
                """);
        jdbcTemplate.execute("CREATE INDEX IF NOT EXISTS idx_load_in_rate_rule_subject_rule ON load_in_rate_rule_subject(rule_id)");
        jdbcTemplate.execute("CREATE INDEX IF NOT EXISTS idx_load_in_rate_rule_subject_subject ON load_in_rate_rule_subject(subject_id)");
    }
