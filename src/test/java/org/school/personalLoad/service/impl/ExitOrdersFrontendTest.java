...
class ExitOrdersFrontendTest {
    ...
    void exitOrderModuleExposesConstructorSettingsAndApprovalWorkflow() throws Exception {
        ...
        assertTrue(page.contains("data-exit-list-view=\"active\""));
        assertTrue(page.contains("data-exit-list-view=\"archive\""));
        assertTrue(classTeacherPage.contains("data-exit-list-view=\"archive\""));
        ...
        assertTrue(script.contains("Дети других классов"));
        assertTrue(script.contains("exitClassTeacherWorkspace && suggestedClasses.length"));
        assertTrue(script.contains("data-exit-toggle-other"));
        ...
        assertTrue(script.contains("order.archived"));
        assertTrue(script.contains("data-exit-action=\"delete\""));
        assertTrue(script.contains("method:'DELETE'"));
        assertTrue(script.contains("if (order.signedScanAvailable) actions.push"));
